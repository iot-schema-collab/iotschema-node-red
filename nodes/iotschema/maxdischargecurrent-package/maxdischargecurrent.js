...
module.exports = function(RED) {
    function maxdischargecurrent(config) {
        ...
        let shapePath = path.join(__dirname,"maxdischargecurrent.jsonld");
    ...
    RED.nodes.registerType("maxdischargecurrent", maxdischargecurrent);
};
