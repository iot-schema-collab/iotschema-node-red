...
module.exports = function(RED) {
    function totalreactivepower(config) {
        ...
        let shapePath = path.join(__dirname,"totalreactivepower.jsonld");
    ...
    RED.nodes.registerType("totalreactivepower", totalreactivepower);
};
