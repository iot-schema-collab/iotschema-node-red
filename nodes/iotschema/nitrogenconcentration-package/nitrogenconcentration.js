...
module.exports = function(RED) {
    function nitrogenconcentration(config) {
        ...
        let shapePath = path.join(__dirname,"nitrogenconcentration.jsonld");
    ...
    RED.nodes.registerType("nitrogenconcentration", nitrogenconcentration);
};
