...
module.exports = function(RED) {
    function argonconcentration(config) {
        ...
        let shapePath = path.join(__dirname,"argonconcentration.jsonld");
    ...
    RED.nodes.registerType("argonconcentration", argonconcentration);
};
