...
module.exports = function(RED) {
    function reactiveenergyimported(config) {
        ...
        let shapePath = path.join(__dirname,"reactiveenergyimported.jsonld");
    ...
    RED.nodes.registerType("reactiveenergyimported", reactiveenergyimported);
};
