...
module.exports = function(RED) {
    function activeenergyexported(config) {
        ...
        let shapePath = path.join(__dirname,"activeenergyexported.jsonld");
    ...
    RED.nodes.registerType("activeenergyexported", activeenergyexported);
};
