...
module.exports = function(RED) {
    function carbondioxideconcentration(config) {
        ...
        let shapePath = path.join(__dirname,"carbondioxideconcentration.jsonld");
    ...
    RED.nodes.registerType("carbondioxideconcentration", carbondioxideconcentration);
};
