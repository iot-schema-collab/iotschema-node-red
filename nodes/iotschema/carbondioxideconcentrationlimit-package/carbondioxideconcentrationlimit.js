...
module.exports = function(RED) {
    function carbondioxideconcentrationlimit(config) {
        ...
        let shapePath = path.join(__dirname,"carbondioxideconcentrationlimit.jsonld");
    ...
    RED.nodes.registerType("carbondioxideconcentrationlimit", carbondioxideconcentrationlimit);
};
