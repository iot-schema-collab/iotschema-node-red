...
module.exports = function(RED) {
    function activeenergyimported(config) {
        ...
        let shapePath = path.join(__dirname,"activeenergyimported.jsonld");
    ...
    RED.nodes.registerType("activeenergyimported", activeenergyimported);
};
