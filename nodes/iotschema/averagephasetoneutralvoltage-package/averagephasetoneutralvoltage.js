...
module.exports = function(RED) {
    function averagephasetoneutralvoltage(config) {
        ...
        let shapePath = path.join(__dirname,"averagephasetoneutralvoltage.jsonld");
    ...
    RED.nodes.registerType("averagephasetoneutralvoltage", averagephasetoneutralvoltage);
};
