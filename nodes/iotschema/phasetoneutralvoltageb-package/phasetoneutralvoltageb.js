...
module.exports = function(RED) {
    function phasetoneutralvoltageb(config) {
        ...
        let shapePath = path.join(__dirname,"phasetoneutralvoltageb.jsonld");
    ...
    RED.nodes.registerType("phasetoneutralvoltageb", phasetoneutralvoltageb);
};
