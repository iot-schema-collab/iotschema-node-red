...
module.exports = function(RED) {
    function reactiveenergyexported(config) {
        ...
        let shapePath = path.join(__dirname,"reactiveenergyexported.jsonld");
    ...
    RED.nodes.registerType("reactiveenergyexported", reactiveenergyexported);
};
