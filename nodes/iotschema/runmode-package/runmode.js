...
module.exports = function(RED) {
    function runmode(config) {
        ...
        let shapePath = path.join(__dirname,"runmode.jsonld");

        
            let checkOptions = ["iot:CoolMode","iot:DryMode","iot:EnergyOrPowerSaverMode","iot:FanMode","iot:SleepMode",];
    ...
    RED.nodes.registerType("runmode", runmode);
};
