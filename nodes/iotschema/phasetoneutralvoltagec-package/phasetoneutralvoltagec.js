...
module.exports = function(RED) {
    function phasetoneutralvoltagec(config) {
        ...
        let shapePath = path.join(__dirname,"phasetoneutralvoltagec.jsonld");
    ...
    RED.nodes.registerType("phasetoneutralvoltagec", phasetoneutralvoltagec);
};
