...
module.exports = function(RED) {
    function soundpressurelevel(config) {
        ...
        let shapePath = path.join(__dirname,"soundpressurelevel.jsonld");
    ...
    RED.nodes.registerType("soundpressurelevel", soundpressurelevel);
};
