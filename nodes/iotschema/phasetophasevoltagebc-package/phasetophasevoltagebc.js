...
module.exports = function(RED) {
    function phasetophasevoltagebc(config) {
        ...
        let shapePath = path.join(__dirname,"phasetophasevoltagebc.jsonld");
    ...
    RED.nodes.registerType("phasetophasevoltagebc", phasetophasevoltagebc);
};
