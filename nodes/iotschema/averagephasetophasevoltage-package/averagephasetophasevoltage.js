...
module.exports = function(RED) {
    function averagephasetophasevoltage(config) {
        ...
        let shapePath = path.join(__dirname,"averagephasetophasevoltage.jsonld");
    ...
    RED.nodes.registerType("averagephasetophasevoltage", averagephasetophasevoltage);
};
