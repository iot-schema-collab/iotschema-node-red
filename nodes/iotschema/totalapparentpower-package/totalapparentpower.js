...
module.exports = function(RED) {
    function totalapparentpower(config) {
        ...
        let shapePath = path.join(__dirname,"totalapparentpower.jsonld");
    ...
    RED.nodes.registerType("totalapparentpower", totalapparentpower);
};
