...
module.exports = function(RED) {
    function averageelectriccurrent(config) {
        ...
        let shapePath = path.join(__dirname,"averageelectriccurrent.jsonld");
    ...
    RED.nodes.registerType("averageelectriccurrent", averageelectriccurrent);
};
