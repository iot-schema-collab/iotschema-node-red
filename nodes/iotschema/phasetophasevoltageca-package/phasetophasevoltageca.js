...
module.exports = function(RED) {
    function phasetophasevoltageca(config) {
        ...
        let shapePath = path.join(__dirname,"phasetophasevoltageca.jsonld");
    ...
    RED.nodes.registerType("phasetophasevoltageca", phasetophasevoltageca);
};
