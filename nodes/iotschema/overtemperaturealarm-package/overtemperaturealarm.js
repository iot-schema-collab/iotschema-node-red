...
module.exports = function(RED) {
    function overtemperaturealarm(config) {
        ...
        let shapePath = path.join(__dirname,"overtemperaturealarm.jsonld");
    ...
    RED.nodes.registerType("overtemperaturealarm", overtemperaturealarm);
};
