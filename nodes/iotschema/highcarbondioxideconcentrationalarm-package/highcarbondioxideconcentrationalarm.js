...
module.exports = function(RED) {
    function highcarbondioxideconcentrationalarm(config) {
        ...
        let shapePath = path.join(__dirname,"highcarbondioxideconcentrationalarm.jsonld");
    ...
    RED.nodes.registerType("highcarbondioxideconcentrationalarm", highcarbondioxideconcentrationalarm);
};
