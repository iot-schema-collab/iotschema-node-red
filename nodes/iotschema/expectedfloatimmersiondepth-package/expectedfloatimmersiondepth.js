...
module.exports = function(RED) {
    function expectedfloatimmersiondepth(config) {
        ...
        let shapePath = path.join(__dirname,"expectedfloatimmersiondepth.jsonld");
    ...
    RED.nodes.registerType("expectedfloatimmersiondepth", expectedfloatimmersiondepth);
};
