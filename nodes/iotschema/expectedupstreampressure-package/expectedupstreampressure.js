...
module.exports = function(RED) {
    function expectedupstreampressure(config) {
        ...
        let shapePath = path.join(__dirname,"expectedupstreampressure.jsonld");
    ...
    RED.nodes.registerType("expectedupstreampressure", expectedupstreampressure);
};
