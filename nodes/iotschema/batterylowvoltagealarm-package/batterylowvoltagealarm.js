...
module.exports = function(RED) {
    function batterylowvoltagealarm(config) {
        ...
        let shapePath = path.join(__dirname,"batterylowvoltagealarm.jsonld");
    ...
    RED.nodes.registerType("batterylowvoltagealarm", batterylowvoltagealarm);
};
