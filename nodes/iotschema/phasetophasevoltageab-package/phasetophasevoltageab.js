...
module.exports = function(RED) {
    function phasetophasevoltageab(config) {
        ...
        let shapePath = path.join(__dirname,"phasetophasevoltageab.jsonld");
    ...
    RED.nodes.registerType("phasetophasevoltageab", phasetophasevoltageab);
};
