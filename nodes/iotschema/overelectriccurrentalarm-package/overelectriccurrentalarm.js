...
module.exports = function(RED) {
    function overelectriccurrentalarm(config) {
        ...
        let shapePath = path.join(__dirname,"overelectriccurrentalarm.jsonld");
    ...
    RED.nodes.registerType("overelectriccurrentalarm", overelectriccurrentalarm);
};
