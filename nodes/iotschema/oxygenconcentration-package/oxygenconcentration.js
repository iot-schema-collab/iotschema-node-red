...
module.exports = function(RED) {
    function oxygenconcentration(config) {
        ...
        let shapePath = path.join(__dirname,"oxygenconcentration.jsonld");
    ...
    RED.nodes.registerType("oxygenconcentration", oxygenconcentration);
};
