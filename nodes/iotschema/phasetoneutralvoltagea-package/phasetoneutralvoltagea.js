...
module.exports = function(RED) {
    function phasetoneutralvoltagea(config) {
        ...
        let shapePath = path.join(__dirname,"phasetoneutralvoltagea.jsonld");
    ...
    RED.nodes.registerType("phasetoneutralvoltagea", phasetoneutralvoltagea);
};
