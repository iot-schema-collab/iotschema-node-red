                    ...
                    if(!config.method) {
                      ...
                      var auth = "Basic " + Buffer.from(config.username + ':' + config.password).toString('base64');
                                    let requestOpts = {
                                        ...
                                        url: "https://129.150.200.242/iot/api/v2/apps/AA5D2D11-C12B-46C7-897F-62A3060F527C/devices/687E0F51-D32D-4D26-B0E5-250395B6A1A2/deviceModels/urn%3Acom%3Asiemens%3Awot%3Afesto/actions/OpenValve",
                                        encoding: null,
                                        body: msgPayload,
					json: true,
                                        headers:{
                        ...
                        RED.nodes.registerType("OpenValve", OpenValve);
                    };
