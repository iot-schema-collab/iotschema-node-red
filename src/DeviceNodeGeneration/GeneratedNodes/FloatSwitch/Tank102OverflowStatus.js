...
module.exports = function(RED) {
    ...
    function Tank102OverflowStatus(config) {
        ...
        if(!config.method) {
            ...
            this.interval_id = null;
                ...
                let requestOpts = {
                    ...
                    url: "https://129.150.200.242/iot/api/v2/apps/AA5D2D11-C12B-46C7-897F-62A3060F527C/devices/687E0F51-D32D-4D26-B0E5-250395B6A1A2/deviceModels/urn%3Acom%3Asiemens%3Awot%3Afesto/attributes/Tank102OverflowStatus",
                    encoding: null,
		    json: true,
                    headers:{
                        "Authorization" : auth
                ...
                serviceCallHttp(node, requestOpts);
                 ...
                 this.on("close", function() {
                    if (this.interval_id != null) {
                        ...
                        RED.nodes.registerType("Tank102OverflowStatus", Tank102OverflowStatus);
                    };
